...
$count=1;
$statment2="select * from student where UG_PG='$ugpg' AND Department='$dip' AND Year_of_Addmission='$adm' AND added='1' order by Student_name";
...
<tr>
        ...
        <td width=300px><b>&nbsp;&nbsp;&nbsp;&nbsp;
        <?php echo $rows2['Student_name'] ?></b></td>
        
        <td align=center> <a class="example_d" href="My Profile student_tuturview.php?id=<?php echo $rows2['Email_id']; ?>" rel="nofollow noopener">Profile</a></td>
       <td align=center><a class="example_d" onClick="<?php echo "javascript: return confirm('Remove this Student from this class?');"?>" href="delete.php?id=<?php echo $rows2['Email_id']; ?>" class="example_d"><u>Remove</u></a></td>


        <td align=center><a class="example_d" href="internal.php?id=<?php echo $rows2['Email_id'];?>"  rel="nofollow noopener">Internal</a></td>
    </tr>
