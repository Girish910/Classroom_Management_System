...
<div class="card-block text-center text-white">
                    <center><div class="m-b-25"> <img src="teacher_imageview_tutor.php?id=<?php echo $rows['Email_id']; ?>" class="img-radius" alt="User-Profile-Image" height=100 width=100>  </div>
