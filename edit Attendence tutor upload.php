...
<pre align="right"><a href="see attendence_teacherview.php" ><b><font size="6px" color="red">Back</font></b></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</pre>


<center><h1 style="background-color:lightgrey;">Edit Students Attendence Upload</h1></center>

<form id="attendence" method="post" action="edit Attendence tutor upload.php">
...
if(isset($_POST['submit']))
{
     ...
     window.location.href='see attendence_teacherview.php'
     </script>";
