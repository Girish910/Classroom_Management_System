...
//$id = $_SESSION['username'];
      ...
      $q=mysqli_query($db,"select * from tutor where Login_id='$user'");
...
<br>
<div>
<form action="internal upload_1.php" method="POST">
...
$ss="SELECT * from work_update where work_id='$work_id' order by student asc";
