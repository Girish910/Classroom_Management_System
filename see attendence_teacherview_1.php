...
?>
    ...
    <tr>
      ...
      <td><button  onclick="window.location.href='edit Attendence tutor upload_1.php?id=<?php echo $rows['att_id']; ?>'">Edit</button></td>
     ...
     <td><a href="att_id_1.php?id=<?php echo $rows['att_id']; ?>">Student's Attendence</a></td>
