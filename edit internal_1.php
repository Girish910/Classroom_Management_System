...
<pre align="right"><a href="internal_tutorview_1.php" ><b><font size="6px" color="red">Back</font></b></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</pre>
...
<br><br>
<center>
<form id="edit work" method="post" action="edit internal_1.php">
...
$url="internal_tutorview.php?id=<?php echo $stu ?>";
  ...
  if($stm)
    ...
    echo "<script>
              ...
              window.location.href='internal_tutorview_1.php';
