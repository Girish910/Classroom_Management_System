...
<div id="id01" class="message">
  ...
  <form class="message-content animate" action="message_1.php" method="post">
...
while($rows=mysqli_fetch_assoc($result))
{
  ...
  $display2="select * from users where Email_id='$email'";
     ...
     $display33=mysqli_query($db,"select * from users where Email_id='$email'");
      $rowsss=mysqli_fetch_assoc($display33);
?>
...
<br>
    <div style="background-color:#add8e6" style="opacity: 1;">
      <br>
        <p><font color="red"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <img align="center" src="teacher_imageview_tutor_1.php?id=<?php echo $rowsss['Email_id']; ?>" class="img-radius" height="35" width="45">  <?php  echo $from;?> :</b></font> <font size=1px color=grey> <b><?php echo  $rows['current'];?> </b> </font><br></p>
...
?>
    ...
    <div style="background-color:#fad1d0" width="80%">
      <br>
        <p><font color="red"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img align="center" src="teacher_imageview_tutor_1.php?id=<?php echo $rowsss['Email_id']; ?>" class="img-radius" height="35" width="45"> <?php echo $rows2['username'];?>:</b></font><font size=1px color=grey> <b><?php echo  $rows['current'];?> </b> </font><br></p>
          <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rows['msg'];?></p>
       <br>        
    </div>
