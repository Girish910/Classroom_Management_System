...
<div class="card-block text-center text-white">
                    <center><div class="m-b-25"> <img src="imageview.php" class="img-radius" alt="User-Profile-Image" height=100 width=100>  </div>
                                <h3 class="f-w-600"> <?php  echo $rows['Tutor_name'];?></h3>
                                <br> <button name=btn1 onclick="window.location.href='edit tutor profile.php'">Edit</button>
                            </div><center>
