...
<pre align="right"><a href="student info_1.php" ><b><font size="6px" color="Red">Back</font></b></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</pre>
...
<div class="card-block text-center text-white">
                    <center><div class="m-b-25"> <img src="student_imageview_tutor_1.php?id=<?php echo $rows['Email_id'];?>" class="img-radius" alt="User-Profile-Image" height=100 width=100>  </div>
