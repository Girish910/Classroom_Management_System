...
<div id="id01" class="request">
  ...
  <form class="request-content animate" action="request_1.php" method="post">
...
$st="select * from users where (class2='$class' or class3='$class' or class4='$class' or class5='$class' or class6='$class' or class7='$class' or class8='$class' or class9='$class' or class10='$class') order by username";
  ...
  if(isset($_POST['send']))
    {
     ...
     // echo "567";
      $statement="INSERT INTO request(current,from_who,to_whom,Sub,msg,class) VALUES('$time1','$from','$to1','$sub','$message','$class')";
