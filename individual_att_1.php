...
//$id = $_SESSION['username'];
    ...
    $display11="select * from users where (class2='$class' or class3='$class' or class4='$class' or class5='$class' or class6='$class' or class7='$class' or class8='$class' or class9='$class' or class10='$class') AND class_type='5'  order by username asc";
...
<br>
<div>
<form action="individual_att_1.php" method="POST">
...
<option value="<?php echo $studentname['Email_id']; ?>"><?php echo $no." ".$studentname['username']; ?></option>
      ...
      if($s2==NULL)
          {
              ...
              $st="INSERT INTO attendence(att_id,upload_date,student,no_of_attendence,percentage,class)
               VALUES('$attid','$date','$name','$att','$att_per','$class')";
...
$ss="SELECT * from attendence where att_id='$att_id' order by student asc";
...
<td class="td2"> <?php echo $count1;  ?></td>
