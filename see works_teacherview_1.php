...
?>
    ...
    <tr>
      <td>  <?php echo $sn;  ?>  </td>
      <!--<td> <MARK>  <?php  echo $rows1['Tutor_name'];?>  </mark> <br> <font size="2px"> <?php  echo $rows['current'];?> </font></td>-->
      ...
      <td><button  onclick="window.location.href='edit student work upload_1.php?id=<?php echo $rows['work_id']; ?>'">Edit</button></td>
     ...
     <td width="125px"><a href="work_id_1.php?id=<?php echo $rows['work_id']; ?>"><b>Internal Upload</b></a></td>
