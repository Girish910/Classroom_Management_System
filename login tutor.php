...
else
{
  ...
  echo "<br>result failed";
    ...
    { 
      ...
      $query123 = "SELECT * FROM tutor WHERE Login_id='$username'"; 
...
<h1 style="background-color:tomato;"><pre>    C L A S S   M A N A G M E N T  S Y S T E M</pre></h1>
<br> <br>
&nbsp&nbsp&nbsp&nbsp<b>&nbspLogin as....</b><br><br> &nbsp&nbsp&nbsp
&nbsp&nbsp&nbsp<button onclick="document.getElementById('id01').style.display='block'" style="width:auto;" class="btn1">Tutor</button>&nbsp&nbsp
<br><br>
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="login tutor.php" method="post">
    ...
    <div class="container" style="background-color:#f1f1f1">
     ...
     <span class="psw"><a href="reset_tutor.php">Reset LoginId & Password</a>
     
     &nbsp &nbsp&nbsp &nbsp <a href="reg_tutor.php">Already Registered as Teacher?</a>

     &nbsp &nbsp&nbsp &nbsp <a href="Reg_tutur_s.php">Newly Register</a>
     </span>
