...
<div class="card-block text-center text-white">
                    <center><div class="m-b-25"> <img src="student_imageview_tutor.php?id=<?php echo $rows['Email_id'];?>" class="img-radius" alt="User-Profile-Image" height=100 width=100>  </div>
...
<tr>  <th align=left> <i>Department Class</i> </th>   <td>:</td>   <td><b> <?php  echo $rows['UG_PG']." ".$rows['Department']." ".$rows['Year_of_Addmission']; ?> </b> </td>    </tr>
