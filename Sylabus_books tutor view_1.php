...
<form method="POST" action="Sylabus&books tutor view_1.php">
...
<center>
<img src="sylabus_view.php?id=<?php echo $r['id_no']; ?>" alt="Syllabus picture NOT uploaded">
