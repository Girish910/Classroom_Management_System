...
<div class="card-block text-center text-white">
                    <center><div class="m-b-25"> <img src="imageview_1.php" class="img-radius" alt="User-Profile-Image" height=100 width=100>  </div>
                                <h3 class="f-w-600"> <?php  echo $rows['Tutor_name'];?></h3>
                                <br> <button name=btn1 onclick="window.location.href='edit tutor profile_1.php'">Edit</button>
                            </div><center>
                        ...
                        <div class="col-sm-8">
                            <div class="card-block">
                                ...
                                <h4>
                                <table align="center" cellpading="25px" cellspacing="25px">
...
<tr>  <th align=left> <i>Current Class<i> </th>   <td>:</td>   <td> <b> <?php  echo $rows['UG_PG']." ".$type1." ".$rows['Department']." ".$rows['Year_of_Admission'];?></b> </td>    </tr>



<!--<tr>  <th align=left> <i>Department</i> </th>   <td>:</td>   <td><b> <?php  echo $rows['Department'];?> </b> </td>    </tr>
<tr>  <th align=left><i> Year Of Admission of Students</i></th>   <td>:</td>   <td><b> <?php  echo $rows['Year_of_Admission'];?> </b>  </td>    </tr>-->
...
<font color="blue"><b><u>MY CLASSES</b></u></font>
<br>
<?php
